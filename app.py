...
def generate_pdf():
    ...
    y = sidebar_skill_category("Data & Systems", [
        "SQL", "Pandas", "NumPy", "MongoDB", "Kafka", "ETL Pipelines", "Streaming Data Systems"
    ], y)
    ...
    # Recorded Future
    y = draw_job(
        "Senior Data Scientist", "Recorded Future", "Jan 2025 \u2013 Present",
        [
        ...
        y, previous="Data Engineer, Data Science Intern",
    )
    y -= BETWEEN_JOBS

    # Tesla
    y = draw_job(
        "Sr. Automation Software Engineer, Team Lead", "Tesla", "2020 \u2013 Dec 2023",
        [
        ...
        y, previous="Automation Software Engineer",
    )
    y -= BETWEEN_JOBS

    # Superior Controls
    y = draw_job(
        "Automation Engineer", "Superior Controls", "2018 \u2013 2020",
        [
