...
DEFAULT_OUTPUT = "patrick_maclea_resume.pdf"


def generate_pdf(output=None):
    """Generate the resume PDF. Pass a file path or BytesIO buffer, or None for default file."""
    if output is None:
    ...
    summary = (
        ...
        "to deliver measurable business impact. Motivated by applying ML to hard, real-world "
        "problems \u2014 from manufacturing automation to cybersecurity intelligence."
    )
    ...
    y = draw_job(
        ...
        [
            ...
            "Championed ML best practices across the software organization by leading ML Guild presentations on modeling techniques, tooling, and production ML workflows.",
    ...
    # ---- Tesla ----
    y = draw_job(
        "Senior Automation Software Engineer, Team Lead",
        "Tesla",
        "2020 \u2013 Dec 2023",
        [
            ...
            "Served as a primary escalation point for production line-down events, rapidly diagnosing and resolving software, controls, and hardware issues to minimize downtime on high-volume manufacturing lines.",
    ...
    y = draw_job(
        ...
        "2018 \u2013 2020",
        [
            "Developed tooling to auto-generate PLC programs from functional specifications, cutting manual programming time across projects.",
            "Delivered PLC control systems for biopharma manufacturing clients, from design specification through integration and validation.",
        ],
        y,
    )
